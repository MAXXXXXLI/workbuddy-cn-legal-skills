---
name: "人工智能治理法务-人工智能系统清单"
description: >
  用于中国大陆人工智能治理法务场景下的人工智能系统清单。适合需要进行法务审查、合规分析、材料整理、风险分级或学习训练时使用。输出默认简体中文；正式依赖前需法务负责人或执业律师核验。

---

## WorkBuddy 中国语境适配（优先）

本 skill 已转换为 WorkBuddy 中国语境版本。当前模块：**人工智能治理法务**；当前技能：**人工智能系统清单**。
