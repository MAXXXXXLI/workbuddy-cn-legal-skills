...
description: >
  ...
  Runs weekly by default. Posts to the channel named in `~/.workbuddy/skills/config/workbuddy-cn-legal/commercial-legal/CLAUDE.md` → House style
...
1. Read `~/.workbuddy/skills/config/workbuddy-cn-legal/commercial-legal/CLAUDE.md` to get the alert destination (企业微信/飞书/钉钉 channel or email list).
