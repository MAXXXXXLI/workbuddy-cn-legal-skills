...
It writes what it learns to `~/.workbuddy/skills/config/workbuddy-cn-legal/commercial-legal/CLAUDE.md` — a plain-English document about your team that every other skill reads before doing anything. You edit the document, not a config file.
...
| Skill | Purpose |
|---|---|
| **cold-start-interview** | First-run interview that writes `~/.workbuddy/skills/config/workbuddy-cn-legal/commercial-legal/CLAUDE.md` |
...
- **上上签/法大大/e签宝/DocuSign** — signature status and envelope tracking
...
With 上上签/法大大/e签宝/DocuSign connected: track signature status, route envelopes in approver order.
...
Your configuration is stored at `~/.workbuddy/skills/config/workbuddy-cn-legal/commercial-legal/CLAUDE.md` and survives plugin updates.
