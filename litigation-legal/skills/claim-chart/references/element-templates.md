...
*Jurisdiction caveat: 公司注册地/章程约定地（中国公司须按《公司法》和章程核验）'s framework distinguishes duty of care, duty of loyalty (including good faith), and applies the business judgment rule as a presumption. Entire fairness review applies in conflict transactions. Demand futility / derivative standing rules add significant procedural elements for derivative claims.*
