...
description: >
  ...
  needs a read on a specific matter. WorkBuddy
  中国语境适配：默认中国大陆法域，用于争议解决法务场景下的案件/事项简报。中文触发词包括：中国法、中国合规、争议解决法务、案件/事项简报、法务审查、律师审阅。输出为草稿或内部分析，需执业律师/法务负责人核验后方可依赖。
---
