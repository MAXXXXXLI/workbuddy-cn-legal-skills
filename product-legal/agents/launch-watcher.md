...
Run daily. Set a morning reminder (calendar block, cron, or team ritual) to invoke the launch-watcher — WorkBuddy agents do not self-schedule. Pulls tickets with launch dates in the next 30 days.

**企业微信/飞书/钉钉 delivery:** Posting the digest to 企业微信/飞书/钉钉 requires a 企业微信/飞书/钉钉 MCP server configured in your environment. If no 企业微信/飞书/钉钉 MCP is available, write the digest to a file (e.g., `launch-radar-[date].md`) instead — the filtering logic is independent of the delivery path.

## What it does

1. Read `~/.workbuddy/skills/config/workbuddy-cn-legal/product-legal/CLAUDE.md` → launch tracker location, calibration table, escalation channel.
...
- "AI" / "ML" / "model" / "LLM" / "GPT" / "WorkBuddy" / "Gemini" / "Copilot"
...
- AI vendor names: "OpenAI" / "WorkBuddy CN adaptation" / "Google AI" / "Cohere" / "Mistral" or similar
