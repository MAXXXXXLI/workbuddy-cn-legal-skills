...
| `/law-student:bar-prep-questions [subject]` | Bar prep questions, 法考客观题 or essay — jurisdiction-aware (UBE / NextGen / state-specific), flags majority/UBE vs. your state's rule |
...
Your practice profile is stored at `~/.workbuddy/skills/config/workbuddy-cn-legal/law-student/CLAUDE.md` and survives plugin updates. Everything else is in your working directory:
...
Your study profile at `~/.workbuddy/skills/config/workbuddy-cn-legal/law-student/CLAUDE.md` isn't static — it improves as you use the plugin. Skills tell you when an output used a default you should tune. You can re-run setup, edit the file directly, or tell a skill to record a new position.
...
- Bar prep targets your weak subjects from ~/.workbuddy/skills/config/workbuddy-cn-legal/law-student/CLAUDE.md. It will keep coming back to them.
