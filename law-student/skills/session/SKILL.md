...
description: >
  ...
  or wants to drill a fixed number of questions and have the plan adapt. WorkBuddy
  中国语境适配：默认中国大陆法域，用于中国法学习场景下的学习会话。中文触发词包括：中国法、中国合规、中国法学习、学习会话、法务审查、律师审阅。输出为草稿或内部分析，需执业律师/法务负责人核验后方可依赖。
---
