...
1. Load `~/.workbuddy/skills/config/workbuddy-cn-legal/law-student/CLAUDE.md` → classes, exam formats, outline locations, learning style.
...
6. Append to `~/.workbuddy/skills/config/workbuddy-cn-legal/law-student/irac-sessions/[student]/tracker.md` for pattern detection. Surface patterns after 3+ sessions.
...
- `~/.workbuddy/skills/config/workbuddy-cn-legal/law-student/CLAUDE.md` → current classes, exam formats, outline locations, learning style
- `~/.workbuddy/skills/config/workbuddy-cn-legal/law-student/irac-sessions/[student]/tracker.md` if exists — pattern tracking across sessions
...
Append to `~/.workbuddy/skills/config/workbuddy-cn-legal/law-student/irac-sessions/[student]/tracker.md`:
