...
本 skill 已转换为 WorkBuddy 中国语境版本。当前模块：**中国法学习**；当前技能：**法律写作点评**。
...
1. Load `~/.workbuddy/skills/config/workbuddy-cn-legal/law-student/CLAUDE.md` → class, writing skill level, past feedback patterns.
...
7. Append to `~/.workbuddy/skills/config/workbuddy-cn-legal/law-student/writing-feedback/[student]/tracker.md` for pattern detection.
...
- `~/.workbuddy/skills/config/workbuddy-cn-legal/law-student/CLAUDE.md` → class, assignment type (if known), writing skill level, graded-essay feedback history
...
Append session summary to `~/.workbuddy/skills/config/workbuddy-cn-legal/law-student/writing-feedback/[student]/tracker.md`:
