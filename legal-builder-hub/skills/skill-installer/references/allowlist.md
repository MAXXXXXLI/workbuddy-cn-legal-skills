...
```
~/.workbuddy/skills/config/workbuddy-cn-legal/legal-builder-hub/allowlist.yaml
```
...
administrator-controlled file that WorkBuddy reads before any analysis runs and
whose enforcement does not depend on WorkBuddy correctly analyzing the skill.
