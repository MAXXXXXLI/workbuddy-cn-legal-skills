...
description: >
  ...
  /legal-builder-hub:uninstall and /legal-builder-hub:disable skills. WorkBuddy
  中国语境适配：默认中国大陆法域，用于技能治理中心场景下的技能管理。中文触发词包括：中国法、中国合规、技能治理中心、技能管理、法务审查、律师审阅。输出为草稿或内部分析，需执业律师/法务负责人核验后方可依赖。
---
