...
description: >
  ...
  notes, or document productions come in for an open investigation. WorkBuddy
  中国语境适配：默认中国大陆法域，用于劳动用工法务场景下的调查记录补充。中文触发词包括：中国法、中国合规、劳动用工法务、调查记录补充、法务审查、律师审阅。输出为草稿或内部分析，需执业律师/法务负责人核验后方可依赖。
---
