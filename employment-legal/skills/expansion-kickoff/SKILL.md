...
description: >
  ...
  "expansion to [country]", or "first hire in [country]". WorkBuddy
  中国语境适配：默认中国大陆法域，用于劳动用工法务场景下的境内外用工扩张启动。中文触发词包括：中国法、中国合规、劳动用工法务、境内外用工扩张启动、法务审查、律师审阅。输出为草稿或内部分析，需执业律师/法务负责人核验后方可依赖。
---
