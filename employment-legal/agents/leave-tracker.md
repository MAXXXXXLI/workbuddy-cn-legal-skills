...
description: >
  ...
  separate integration — WorkBuddy agents do not self-schedule.
...
> jurisdiction in `~/.workbuddy/skills/config/workbuddy-cn-legal/employment-legal/CLAUDE.md`, identify the currently operative leave statutes,
...
Read `~/.workbuddy/skills/config/workbuddy-cn-legal/employment-legal/CLAUDE.md`. Extract:
...
**If manual:**
Read `~/.workbuddy/skills/config/workbuddy-cn-legal/employment-legal/leave-register.yaml`. If the file doesn't exist, prompt:
...
preference in `~/.workbuddy/skills/config/workbuddy-cn-legal/employment-legal/CLAUDE.md`):
...
(3) Escalation per `~/.workbuddy/skills/config/workbuddy-cn-legal/employment-legal/CLAUDE.md` before proceeding.
...
After running, update `~/.workbuddy/skills/config/workbuddy-cn-legal/employment-legal/leave-register.yaml` with recalculated fields
...
`~/.workbuddy/skills/config/workbuddy-cn-legal/employment-legal/leave-register.yaml`:
