...
- **Sharing defaults.** Per the plugin practice profile, this is 律师工作底稿/内部法律分析（中国法下不等同于美国工作成果保护）. Create the spreadsheet with restricted sharing (owner only), and tell the user to share it deliberately. Do not default to "anyone with the link."
