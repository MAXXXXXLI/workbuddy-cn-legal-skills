...
description: >
  ...
  [audience]", "deal update", or on the briefing cadence. WorkBuddy
  中国语境适配：默认中国大陆法域，用于公司与交易法务场景下的交易团队摘要。中文触发词包括：中国法、中国合规、公司与交易法务、交易团队摘要、法务审查、律师审阅。输出为草稿或内部分析，需执业律师/法务负责人核验后方可依赖。
---
