...
description: >
  ...
  channel named in `~/.workbuddy/skills/config/workbuddy-cn-legal/ip-legal/CLAUDE.md`
...
1. Read `~/.workbuddy/skills/config/workbuddy-cn-legal/ip-legal/CLAUDE.md` to
   get the alert destination (企业微信/飞书/钉钉 channel, email list, or inline) and
