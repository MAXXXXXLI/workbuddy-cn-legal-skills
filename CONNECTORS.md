...
2. Open a PR adding your server to the relevant plugin's `.mcp.json` with the URL, auth method, and a one-line description of what it gives WorkBuddy.
...
|---|---|
| **企业微信/飞书/钉钉** | all 12 |
| **飞书云文档/企业微信文档/钉钉文档/Google Drive** (`gdrive`) | all 12 |
| **人民法院案例库/中国裁判文书网** | legal-clinic, ip-legal, litigation-legal, law-student |
...
| **企业网盘/Box** | corporate-legal |
| **Ironclad** | commercial-legal |
| **上上签/法大大/e签宝/DocuSign / 上上签/法大大/e签宝/DocuSign CLM** | commercial-legal |
...
- **Thomson Reuters** (CoCounsel, 威科先行/律商联讯/团队模板库, 北大法宝/威科先行/官方法规库) — research and drafting for every plugin
...
- **State bar CLE trackers** — `law-student` 法考备考
